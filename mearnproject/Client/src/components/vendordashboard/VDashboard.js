...
const VDashboard = () => {
    ...
    function fetchVendors(tokens) {
        axios.get("http://localhost:3000/api/vendor-get-events", { headers: { "Authorization": `Bearer ${tokens}` } })
            .then((res) => {
                        ...
                        <div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
                            <div class="sidebar">
                                ...
                                <div class="widget user-dashboard-menu">
                                    <ul>
                                        <li class="active"><a href="/vendor-dashboard"><i class="fa fa-bookmark-o"></i> My Works</a></li>
                                        <li><a href="/vendor-events"><i class="fa fa-user"></i> New  Events</a></li>
